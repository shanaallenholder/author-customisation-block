...
.editor-inserter-sidebar .block-editor-block-patterns-list__item .block-editor-block-preview__container {
  box-shadow: 0 15px 25px rgba(0, 0, 0, 0.07);
}
.editor-inserter-sidebar .block-editor-block-patterns-list__item:focus .block-editor-block-preview__container, .editor-inserter-sidebar .block-editor-block-patterns-list__item:hover .block-editor-block-preview__container {
  box-shadow: 0 0 0 2px #1e1e1e, 0 15px 25px rgba(0, 0, 0, 0.07);
}
.editor-inserter-sidebar .block-editor-block-patterns-list__item.block-editor-block-patterns-list__list-item-synced:hover .block-editor-block-preview__container, .editor-inserter-sidebar .block-editor-block-patterns-list__item.block-editor-block-patterns-list__list-item-synced:focus .block-editor-block-preview__container {
