...
export default {
  ...
  inspectorControls: function GridLayoutInspectorControls({
    ...
    return createElement(Fragment, null, createElement(GridLayoutTypeControl, {
      layout: layout,
      onChange: onChange
    }), layout?.columnCount ? createElement(GridLayoutColumnsAndRowsControl, {
      layout: layout,
      onChange: onChange,
  ...
  toolBarControls: function GridLayoutToolbarControls({
    ...
    return createElement(GridVisualizer, {
      clientId: clientId
    });
  },
...
function GridLayoutColumnsAndRowsControl({
  ...
  return createElement(Fragment, null, createElement("fieldset", null, createElement(BaseControl.VisualLabel, {
    as: "legend"
    ...
    label: __('Columns'),
    hideLabelFromVision: true
  })))), allowSizingOnChildren && window.__experimentalEnableGridInteractivity && createElement("fieldset", null, createElement(BaseControl.VisualLabel, {
    as: "legend"
  }, __('Rows')), createElement(Flex, {
    gap: 4
  }, createElement(FlexItem, {
    isBlock: true
  }, createElement(NumberControl, {
