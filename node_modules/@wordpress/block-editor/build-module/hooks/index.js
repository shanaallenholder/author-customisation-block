...
createBlockEditFilter([align, textAlign, anchor, customClassName, style, duotone, position, layout, contentLockUI, blockHooks, childLayout].filter(Boolean));
createBlockListBlockFilter([align, textAlign, background, style, color, dimensions, duotone, fontFamily, fontSize, border, position, childLayout]);
