...
function BlockSelectionButton({
  ...
  return createElement("div", {
    ...
    icon: icon,
    showColors: true
  })), showBlockDraggable && createElement(FlexItem, null, createElement(BlockDraggable, {
    clientIds: [clientId]
    ...
    tabIndex: "-1",
    ...draggableProps
  }))), editorMode === 'zoom-out' && !isBlockTemplatePart && createElement(FlexItem, null, createElement(BlockMover, {
    clientIds: [clientId],
    hideDragHandle: true,
    isBlockMoverUpButtonDisabled: isPrevBlockTemplatePart,
    isBlockMoverDownButtonDisabled: isNextBlockTemplatePart
  })), canMove && canRemove && editorMode === 'zoom-out' && createElement(Shuffle, {
    clientId: clientId,
    as: Button
  }), canRemove && editorMode === 'zoom-out' && !isBlockTemplatePart && createElement(FlexItem, null, createElement(ToolbarButton, {
    icon: trash,
    label: "Delete",
    onClick: () => {
      removeBlock(clientId);
    }
  })), editorMode === 'navigation' && createElement(FlexItem, null, createElement(Button, {
    ref: ref,
