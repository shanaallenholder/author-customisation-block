...
const BlockSettingsMenuControlsSlot = ({
  ...
  return createElement(Slot, {
    ...
    return createElement(MenuGroup, null, showConvertToGroupButton && createElement(ConvertToGroupButton, {
      ...
      clientId: selectedClientIds[0]
    }), fills, fillProps?.canMove && !fillProps?.onlyBlock && !isContentOnly && createElement(MenuItem, {
      onClick: pipe(fillProps?.onClose, fillProps?.onMoveTo)
    }, __('Move to')), fillProps?.count === 1 && !isContentOnly && createElement(BlockModeToggle, {
