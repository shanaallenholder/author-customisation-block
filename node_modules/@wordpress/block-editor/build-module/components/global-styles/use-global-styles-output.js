...
export const toStyles = (tree, blockSelectors, hasBlockGapSupport, hasFallbackGapSupport, disableLayoutStyles = false, isTemplate = true, styleOptions = undefined) => {
  ...
  if (options.blockGap && hasBlockGapSupport) {
    ...
    ruleset = ruleset + ':where(.wp-site-blocks) > :first-child { margin-block-start: 0; }';
    ruleset = ruleset + ':where(.wp-site-blocks) > :last-child { margin-block-end: 0; }';
  }
  if (options.presets) {
