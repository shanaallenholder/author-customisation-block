...
export function PrivateBlockToolbar({
  ...
  }, !isMultiToolbar && isLargeViewport && isDefaultEditingMode && createElement(BlockParentSelector, null), isUsingBindings && canBindBlock(blockName) && createElement(BlockBindingsIndicator, null), (shouldShowVisualToolbar || isMultiToolbar) && (isDefaultEditingMode || isSynced) && createElement("div", {
    ref: nodeRef,
  ...
  }), isDefaultEditingMode && createElement(Fragment, null, !isMultiToolbar && createElement(BlockLockToolbar, {
