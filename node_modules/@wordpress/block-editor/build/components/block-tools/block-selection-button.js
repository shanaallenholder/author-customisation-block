...
function BlockSelectionButton({
  ...
  return (0, _react.createElement)("div", {
    ...
    icon: icon,
    showColors: true
  })), showBlockDraggable && (0, _react.createElement)(_components.FlexItem, null, (0, _react.createElement)(_blockDraggable.default, {
    clientIds: [clientId]
    ...
    tabIndex: "-1",
    ...draggableProps
  }))), editorMode === 'zoom-out' && !isBlockTemplatePart && (0, _react.createElement)(_components.FlexItem, null, (0, _react.createElement)(_blockMover.default, {
    clientIds: [clientId],
    hideDragHandle: true,
    isBlockMoverUpButtonDisabled: isPrevBlockTemplatePart,
    isBlockMoverDownButtonDisabled: isNextBlockTemplatePart
  })), canMove && canRemove && editorMode === 'zoom-out' && (0, _react.createElement)(_shuffle.default, {
    clientId: clientId,
    as: _components.Button
  }), canRemove && editorMode === 'zoom-out' && !isBlockTemplatePart && (0, _react.createElement)(_components.FlexItem, null, (0, _react.createElement)(_components.ToolbarButton, {
    icon: _icons.trash,
    label: "Delete",
    onClick: () => {
      removeBlock(clientId);
    }
  })), editorMode === 'navigation' && (0, _react.createElement)(_components.FlexItem, null, (0, _react.createElement)(_components.Button, {
    ref: ref,
