...
function BackgroundSizeToolsPanelItem({
  ...
  })), currentValueForToggle !== undefined && currentValueForToggle !== 'cover' && currentValueForToggle !== 'contain' ? (0, _react.createElement)(_components.__experimentalUnitControl, {
    size: '__unstable-large',
    onChange: updateBackgroundSize,
    value: sizeValue
