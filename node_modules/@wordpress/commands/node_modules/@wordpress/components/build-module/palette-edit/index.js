...
export function PaletteEdit({
  ...
  return createElement(PaletteEditStyles, null, createElement(HStack, null, createElement(PaletteHeading, {
  ...
  }, isGradient ? __('Reset gradient') : __('Reset colors'))))))), hasElements && createElement(PaletteEditContents, null, isEditing && createElement(PaletteEditListView, {
    canOnlyChangeValues: canOnlyChangeValues,
    elements: elements
  ...
  }))), !hasElements && emptyMessage && createElement(PaletteEditContents, null, emptyMessage));
}
