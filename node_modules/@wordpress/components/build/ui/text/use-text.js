...
function useText(props) {
  ...
  if (!truncate && Array.isArray(children)) {
    content = _element.Children.map(children, function (child) {
      // @ts-ignore
...
function getLineHeight(_ref) {
  ...
  if (!(0, _lodash.isNil)(lineHeight)) return lineHeight;
  if (!adjustLineHeightForInnerControls) return;
  var value = "calc(".concat(_styles.ui.get('controlHeight'), " + ").concat(_styles.ui.space(2), ")");

  switch (adjustLineHeightForInnerControls) {
    case 'large':
      value = "calc(".concat(_styles.ui.get('controlHeightLarge'), " + ").concat(_styles.ui.space(2), ")");
      break;

    case 'small':
      value = "calc(".concat(_styles.ui.get('controlHeightSmall'), " + ").concat(_styles.ui.space(2), ")");
      break;

    case 'xSmall':
      value = "calc(".concat(_styles.ui.get('controlHeightXSmall'), " + ").concat(_styles.ui.space(2), ")");
      break;
