 ...
 */
export function contextConnect<P>(Component: React.ForwardRefRenderFunction<import("@wp-g2/create-styles/types").ElementTypeFromViewOwnProps<P>, P>, namespace: Array<string> | string, options?: {
    memo: boolean | undefined;
}): import("@wp-g2/create-styles/types").PolymorphicComponent<import("@wp-g2/create-styles/types").ElementTypeFromViewOwnProps<P>, P>;
/**
