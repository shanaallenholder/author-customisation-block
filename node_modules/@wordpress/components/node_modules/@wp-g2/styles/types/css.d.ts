 ...
 */
export function css(template: TemplateStringsArray | import('create-emotion').Interpolation<undefined>, ...args: import('create-emotion').Interpolation<undefined>[]): ReturnType<{
