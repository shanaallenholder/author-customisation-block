...
function SelectDropdown(props, forwardedRef) {
  var _useSelectDropdown = (0, _useSelectDropdown2.useSelectDropdown)(props),
      ...
      otherProps = (0, _objectWithoutProperties2.default)(_useSelectDropdown, ["dropdownMenuProps", "hideLabelFromVision", "isOpen", "items", "label", "labelProps", "placeholder", "popoverProps", "popoverRef", "referenceProps", "referenceRef", "resizer"]);
  ...
  return /*#__PURE__*/_react.default.createElement(_View.View, Object.assign({}, otherProps, {
    ...
    as: "button"
  }, referenceProps), /*#__PURE__*/_react.default.createElement(_Truncate.Truncate, null, referenceProps.children)), /*#__PURE__*/_react.default.createElement(_Portal.Portal, null, /*#__PURE__*/_react.default.createElement(_View.View, popoverProps, /*#__PURE__*/_react.default.createElement(_selectDropdownLabel.default, labelProps), isOpen && /*#__PURE__*/_react.default.createElement(_Dropdown.DropdownMenuCard, dropdownMenuProps, items.map(function (item) {
