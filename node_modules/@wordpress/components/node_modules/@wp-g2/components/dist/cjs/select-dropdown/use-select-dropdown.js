...
function useSelectDropdown(props) {
  ...
  var _popoverProps = getMenuProps(_objectSpread(_objectSpread({}, _styles.ui.$('SelectDropdownPopover')), {}, {
  ...
  var popoverProps = _objectSpread(_objectSpread({}, _popoverProps), {}, {
    ref: (0, _utils.mergeRefs)([_popoverProps.ref, popoverRef])
  });
  ...
  var dropdownMenuProps = _objectSpread(_objectSpread({}, _styles.ui.$('SelectDropdownMenu')), {}, {
    className: (0, _styles.cx)(styles.DropdownMenu, (0, _styles.css)({
      minWidth: minWidth
    }))
  });
  /**
