...
var styles = _interopRequireWildcard(require("./Flex.styles"));
...
function useFlex(props) {
  var _useContextSystem = (0, _context.useContextSystem)(props, 'Flex'),
      ...
      otherProps = (0, _objectWithoutProperties2.default)(_useContextSystem, ["align", "alignItems", "className", "direction", "expanded", "gap", "justify", "justifyContent", "wrap"]);

  var direction = (0, _styles.useResponsiveValue)(directionProp);
  ...
  var classes = (0, _react.useMemo)(function () {
    ...
    var sx = {};
    sx.Base = (0, _styles.css)((_css = {}, _css[_styles.ui.createToken('FlexGap')] = _styles.ui.space(gap), _css[_styles.ui.createToken('FlexItemDisplay')] = isColumn ? 'block' : null, _css[_styles.ui.createToken('FlexItemMarginBottom')] = isColumn ? _styles.ui.get('FlexGap') : 0, _css[_styles.ui.createToken('FlexItemMarginRight')] = !isColumn && !isReverse ? _styles.ui.get('FlexGap') : 0, _css[_styles.ui.createToken('FlexItemMarginLeft')] = !isColumn && isReverse ? _styles.ui.get('FlexGap') : 0, _css.alignItems = alignItems || isColumn ? 'normal' : align, _css.flexDirection = direction, _css.flexWrap = wrap ? 'wrap' : undefined, _css.justifyContent = justifyContent || justify, _css.height = isColumn && expanded ? '100%' : undefined, _css.width = !isColumn && expanded ? '100%' : undefined, _css['> * + *:not(marquee)'] = {
      marginTop: isColumn ? _styles.ui.space(gap) : undefined,
      marginRight: !isColumn && isReverse ? _styles.ui.space(gap) : undefined,
      marginLeft: !isColumn && !isReverse ? _styles.ui.space(gap) : undefined
    }, _css['> *'] = {
      minWidth: !isColumn ? 0 : null,
      minHeight: isColumn ? 0 : null
    }, _css));
    return (0, _styles.cx)(styles.Flex, sx.Base, className);
