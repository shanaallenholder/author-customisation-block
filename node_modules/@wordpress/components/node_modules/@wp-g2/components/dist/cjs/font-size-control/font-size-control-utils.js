...
exports.getSelectTemplateColumns = getSelectTemplateColumns;
exports.getSliderTemplateColumns = getSliderTemplateColumns;
...
function getSelectTemplateColumns(withNumberInput) {
  return withNumberInput ? "minmax(0, 1fr) minmax(auto, " + _styles.ui.value.px(ASIDE_CONTROL_WIDTH * 2) + ")" : "minmax(0, 2fr) minmax(auto, " + _styles.ui.value.px(ASIDE_CONTROL_WIDTH) + ")";
}

function getSliderTemplateColumns() {
  return "2fr minmax(auto, " + _styles.ui.value.px(ASIDE_CONTROL_WIDTH) + ")";
}