 ...
 */
export default function useTruncate(props: import('@wp-g2/create-styles').ViewOwnProps<Props, 'span'>): {
    className: string;
    children: string;
...
export type Props = {
    /**
     * String to use to truncate the string with.
     */
...
//# sourceMappingURL=use-truncate.d.ts.map